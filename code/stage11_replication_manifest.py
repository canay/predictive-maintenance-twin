...
def main():
    rows = [
        ...
        row(
            "C-MAPSS temporal benchmark comparison",
            ...
            "Fixed configurations were evaluated post hoc on official test sets; the local folder preserves manifests and metrics from the Linux VPS run.",
        ),
        row(
    ...
    manifest = {
        ...
        "items": rows,
        "tex_facing_figures": [
            file_info("manuscript/fig_architecture.pdf"),
        ...
        "figure_source_output_layout": {
            "tex_facing_outputs": "The TeX uses manuscript/fig_architecture.pdf for the text-bearing diagram and manuscript/fig_*.png for the remaining figures.",
