...
ck("q1_partial_calibration", ("benchmark-anchored and partially calibrated" in tex or "benchmark-anchored, partially calibrated" in tex) and "partially calibrated simulator" in tex)
